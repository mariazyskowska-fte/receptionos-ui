...
function ReportSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "flex", children: [
        /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: cn("w-1 flex-shrink-0", v.accent) }),
        /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "flex-1 flex flex-col", children: [
          /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "flex items-center justify-between px-4 pt-4 pb-2", children: [
            /* @__PURE__ */ (0, import_jsx_runtime25.jsxs)("div", { className: "flex items-center gap-2", children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("p", { className: cn("text-[13px] leading-[18px] font-semibold", v.titleColor), children: title })
            ] }),
            headerRight
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime25.jsx)("div", { className: "px-4 pb-4", children })
        ] })
      ] })
    }
  );
...
function CardStack({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsxs)("div", { className: cn("flex flex-col gap-3", className), children: [
    /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("div", { ref: containerRef, className: "relative w-full overflow-hidden", style: { minHeight: 180 }, children: cards.map((card, i) => {
