...
function ReportBreakdown({
  ...
  return /* @__PURE__ */ jsxs14(
    "div",
    {
      ...
      children: [
        (title || overallScore != null) && /* @__PURE__ */ jsxs14("div", { className: "flex items-center justify-between p-6 pb-0", children: [
          title && /* @__PURE__ */ jsx17("p", { className: "text-[14px] leading-[20px] font-medium text-ros-ink", children: title }),
          overallScore != null && /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx17("span", { className: "text-[28px] leading-none font-medium text-ros-ink", children: overallScore }),
            /* @__PURE__ */ jsx17("span", { className: "text-[12px] text-ros-ink-muted", children: "/100" }),
            previousOverallScore != null && previousOverallScore !== overallScore && /* @__PURE__ */ jsx17(
              Badge,
              {
        ...
        /* @__PURE__ */ jsxs14("div", { className: "p-6 flex flex-col gap-3", children: [
          /* @__PURE__ */ jsx17("p", { className: "text-[12px] leading-[16px] font-semibold text-ros-ink-muted uppercase tracking-wide", children: "Breakdown" }),
          /* @__PURE__ */ jsx17("div", { className: "flex flex-col gap-2", children: sortedAreas.map((area) => {
                ...
                children: [
                  /* @__PURE__ */ jsxs14("div", { className: "flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2", children: [
                      isWeakest && /* @__PURE__ */ jsx17("span", { className: "text-[12px]", "aria-label": "Najs\u0142abszy obszar", children: "\u2757" }),
                      /* @__PURE__ */ jsx17("span", { className: "text-[14px] leading-[20px] font-medium text-ros-ink", children: area.name })
                    ] }),
                    /* @__PURE__ */ jsxs14("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsx17(
                        "div",
                      ...
                      area.previousScore != null && area.previousScore !== area.score && /* @__PURE__ */ jsx17(
                        Badge,
                        {
                  ...
                  /* @__PURE__ */ jsx17("div", { className: "w-full h-1.5 bg-ros-surface-off rounded-pill overflow-hidden", children: /* @__PURE__ */ jsx17(
                    "div",
                    {
                      className: cn(
                  ...
                  area.quote && /* @__PURE__ */ jsxs14("div", { className: "flex items-start gap-2 mt-1", children: [
                    /* @__PURE__ */ jsx17("span", { className: "text-[12px] flex-shrink-0 mt-0.5", children: area.quoteType === "positive" ? "\u2713" : "\u2757" }),
                    /* @__PURE__ */ jsxs14("p", { className: "text-[12px] leading-[16px] text-ros-ink-muted italic", children: [
                      "\u201E",
                      area.quote,
                      '"'
                    ] })
        ...
        visibleSuggestions && visibleSuggestions.length > 0 && /* @__PURE__ */ jsxs14("div", { className: "border-t border-ros-border p-6 flex flex-col gap-3", children: [
          ...
          /* @__PURE__ */ jsx17("div", { className: "flex flex-col gap-3", children: visibleSuggestions.map((s, i) => /* @__PURE__ */ jsxs14(
            "div",
            {
              className: "flex flex-col gap-1.5 p-3 rounded-input bg-ros-surface-off border border-ros-border",
              children: [
                /* @__PURE__ */ jsx17("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsx17(Badge, { tone: scoreTone2(
                  areas.find((a) => a.name === s.area)?.score ?? 0
                ), children: s.area }) }),
                /* @__PURE__ */ jsx17("p", { className: "text-[14px] leading-[20px] text-ros-ink", children: s.text }),
                s.sourceQuote && /* @__PURE__ */ jsxs14("p", { className: "text-[12px] leading-[16px] text-ros-ink-muted italic", children: [
                  "Kontekst: \u201E",
                  s.sourceQuote,
                  '"'
                ] })
...
function DashboardLayout({
  ...
  return /* @__PURE__ */ jsxs17("div", { className: cn("flex gap-6 items-start", className), children: [
    /* @__PURE__ */ jsx20("div", { className: "flex-1 min-w-0 flex flex-col gap-4", children }),
    /* @__PURE__ */ jsxs17("aside", { className: "w-[384px] min-w-[384px] flex-shrink-0 sticky top-[80px] max-h-[calc(100vh-96px)] flex flex-col rounded-card border border-ros-border bg-white overflow-hidden", children: [
      /* @__PURE__ */ jsx20("div", { className: "px-4 py-3 border-b border-ros-border flex items-center justify-between", children: /* @__PURE__ */ jsx20("p", { className: "text-[14px] leading-[20px] font-semibold text-ros-ink", children: panelTitle }) }),
      panelToolbar && /* @__PURE__ */ jsx20("div", { className: "px-3 py-2 border-b border-ros-border bg-ros-surface-off", children: panelToolbar }),
      /* @__PURE__ */ jsx20("div", { className: "flex-1 overflow-y-auto p-2 flex flex-col gap-1", children: panel }),
      panelFooter && /* @__PURE__ */ jsx20("div", { className: "px-3 py-2.5 border-t border-ros-border bg-white", children: panelFooter })
    ] })
  ] });
}
function TeamPanelToolbar({
  ...
  return /* @__PURE__ */ jsx20("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs17("label", { className: "flex items-center gap-2 cursor-pointer", children: [
    /* @__PURE__ */ jsx20(
      "input",
      {
        type: "checkbox",
    ...
    /* @__PURE__ */ jsx20("span", { className: "text-[12px] text-ros-ink-muted", children: selectedCount > 0 ? `${selectedCount} z ${totalCount}` : `Zaznacz wszystko` })
  ] }) });
}
...
function ActivityLog({
  ...
  if (entries.length === 0) {
    return /* @__PURE__ */ jsx21("div", { className: cn("rounded-card border border-ros-border bg-white p-4", className), children: /* @__PURE__ */ jsx21("p", { className: "text-[12px] text-ros-ink-muted text-center py-4", children: "Brak aktywno\u015Bci" }) });
  }
  return /* @__PURE__ */ jsxs18(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx21("div", { className: "px-4 py-3 border-b border-ros-border", children: /* @__PURE__ */ jsx21("p", { className: "text-[12px] leading-[16px] font-semibold text-ros-ink-muted uppercase tracking-wide", children: "Historia" }) }),
        /* @__PURE__ */ jsx21("div", { className: "flex flex-col", children: visible.map((entry, i) => {
          ...
          return /* @__PURE__ */ jsxs18(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx21("div", { className: "flex flex-col items-center pt-0.5 flex-shrink-0", children: /* @__PURE__ */ jsx21("span", { className: "text-[12px] leading-none", children: entry.iconLabel ?? cfg.icon }) }),
                /* @__PURE__ */ jsxs18("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxs18("div", { className: "flex items-start justify-between gap-2", children: [
                    /* @__PURE__ */ jsx21("p", { className: "text-[13px] leading-[18px] text-ros-ink", children: entry.text }),
                    /* @__PURE__ */ jsx21("span", { className: "text-[11px] text-ros-ink-faint flex-shrink-0 whitespace-nowrap", children: entry.timestamp })
                  ] }),
                  entry.detail && /* @__PURE__ */ jsx21("p", { className: "text-[12px] leading-[16px] text-ros-ink-muted mt-0.5", children: entry.detail })
                ] })
              ]
            },
            i
